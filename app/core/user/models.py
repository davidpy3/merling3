...
class User(AbstractBaseUser, PermissionsMixin):
    ...
    mobile_phone = models.CharField(max_length=10, unique=True, verbose_name='Teléfono celular')
    landline = models.CharField(max_length=10, unique=True, null=True, blank=True, verbose_name='Teléfono convencional')
