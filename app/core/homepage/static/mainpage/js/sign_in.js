...
$(function() {
    ...
    // $(fv.form).find('input[name="first_name"]').val('Oscar Bermeo');
    // $(fv.form).find('input[name="last_name"]').val('Xavier Almeida');
    // $(fv.form).find('input[name="dni"]').val('0913960944');
    // $(fv.form).find('input[name="mobile_phone"]').val('0979014552');
    // $(fv.form).find('input[name="landline"]').val('2977552');
    // $(fv.form).find('input[name="password"]').val('hacker94');
    // $(fv.form).find('input[name="address"]').val('Milagro');
    // $(fv.form).find('input[name="email"]').val('williamjair94@hotmail.com');
});